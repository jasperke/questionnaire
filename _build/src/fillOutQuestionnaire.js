require(['quizPool', 'jquery', 'underscore'], function (Q, $, _) {

console.log(Q.commonOptions[0]);
return {a:_.first(Q.commonOptions)};
	...
	var q_id,
		...
		answer = [],
		quizzes;
console.log('fillOutQuestionnaire.js:'+new Date().getTime());
	...
	function setQuest(direction) {
		...
		$.each(Q.quizPool[quiz_id].options || Q.quizPool.commonOptions, function (i) {
			$("#optlist").append(
